...
- **GitHub account** — The MCP Registry supports [multiple authentication methods](./how-to/authenticate.mdx). authentication. For simplicity, this tutorial will use GitHub-based authentication, so you will need a [GitHub](https://github.com/) account.
...
- Learn how to [use other authentication methods](./how-to/authenticate.mdx), such as [DNS authentication](./how-to/authenticate.mdx#dns-authentication) which enables custom domains for server name prefixes.
- Learn how to [automate publishing with GitHub Actions](./how-to/github-actions.mdx).
