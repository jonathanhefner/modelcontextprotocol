...
export interface Resource {
  ...
  /**
   * Indicates whether the resource content may also be read directly via its URI. Reading the resource this way can be more performant than reading via resources/read.
   *
   * If the server is remote, the client should verify that the URI is accessible before reading. For example, a file:/// URI returned by a remote server would not be directly accessible to the client.
   *
   * The resource may still be read via resources/read regardless of this value.
   */
